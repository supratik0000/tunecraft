...
export function seedCatalog() {
  const insert = db.prepare(`
    INSERT INTO tracks (id, name, artist, album, genre, emoji, color, bpm, music_key, mood, duration, owner_id)
    VALUES (@id, @name, @artist, @album, @genre, @emoji, @color, @bpm, @music_key, @mood, @duration, NULL)
    ON CONFLICT(id) DO UPDATE SET
      ...
      mood=excluded.mood, duration=excluded.duration
